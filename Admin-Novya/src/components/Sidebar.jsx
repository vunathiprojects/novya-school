...
// import {
//   FaTachometerAlt, FaMoneyBill, FaChartLine,
//   FaTicketAlt, FaHeadset, FaHistory, FaUserClock,
//   FaUserPlus, FaSearch, FaRegPlayCircle
// } from 'react-icons/fa';
...
//     // { name: 'Free Demo', icon: <FaRegPlayCircle />, path: 'freedemo' },
//     { name: 'Support and Tickets', icon: <FaTicketAlt />, path: 'tickets' },
//     // { name: 'Admin Activity Log', icon: <FaUserClock />, path: 'admin-logs' },
...
//       setTimeout(() => setVisibleItems(prev => [...prev, index]), index * 50);
//     });
//   }, [searchQuery]);
